...
ALTER TABLE BUECHER
    ADD BESCHREIBUNG VARCHAR(2000);

ALTER TABLE BUECHER
    MODIFY OLID VARCHAR(100) NOT NULL;
...
ALTER TABLE BUCHBEZIEHUNG_JT
    ADD KOMMENTARE VARCHAR(2000) NULL ;

ALTER TABLE BUCHBEZIEHUNG_JT
    MODIFY STERNE INT NULL ;
...
INSERT INTO BUCHBEZIEHUNG_JT (BUCH_ID, BENUTZER_ID, STATUS, ANFANGSDATUM, KOMMENTAR, STERNE)
VALUES (1, 1, 'Favoriten', NOW(), null, null);

DELETE FROM BUCHBEZIEHUNG_JT WHERE BENUTZER_ID = 1;

SHOW COLUMNS FROM BUCHBEZIEHUNG_JT;
